def generate_problem_file(problem_name, grid_size, cars_vertical, cars_horizontal, trucks_vertical, trucks_horizontal):
    ...
    if cars_horizontal:
        cars += " " + " ".join(cars_horizontal.keys()) + " - horizontalCar"
    if cars_vertical:
        cars+= "\n"
    if cars_vertical:
        cars += " " + " ".join(cars_vertical.keys()) + " - verticalCar"

    trucks = ";;Trucks: Represents trucks in the grid, identified by their names (e.g., green-truck).\n"
    if trucks_horizontal:
        trucks += " " + " ".join(trucks_horizontal.keys()) + " - horizontalTruck"
    if trucks_vertical:
        trucks+= "\n"
    if trucks_vertical:
        trucks += " " + " ".join(trucks_vertical.keys()) + " - verticalTruck"
