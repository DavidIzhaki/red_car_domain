(define (problem Red-Car-Problem15-Expert)
(:domain RedCar)
(:objects
...
;;Cars: Represents cars in the grid, identified by their names (e.g., red-car).
 red-car yellow-hover-car brown-car - horizontalCar
 orange-car pink-car green-car purple-car yellow-car green-hover-car white-gray-car - verticalCar
;;Trucks: Represents trucks in the grid, identified by their names (e.g., green-truck).
 blue-truck purple-truck - horizontalTruck
...
(at-car-horizontal yellow-hover-car cube-x1-y3 cube-x2-y3)
(not (clear cube-x1-y3))
(not (clear cube-x2-y3))
(at-car-horizontal brown-car cube-x0-y5 cube-x1-y5)
(not (clear cube-x0-y5))
(not (clear cube-x1-y5))
(at-car-vertical orange-car cube-x1-y0 cube-x1-y1)
(not (clear cube-x1-y0))
(not (clear cube-x1-y1))
(at-car-vertical pink-car cube-x4-y0 cube-x4-y1)
(not (clear cube-x4-y0))
(not (clear cube-x4-y1))
(at-car-vertical green-car cube-x0-y0 cube-x0-y1)
(not (clear cube-x0-y0))
(not (clear cube-x0-y1))
(at-car-vertical purple-car cube-x5-y0 cube-x5-y1)
(not (clear cube-x5-y0))
(not (clear cube-x5-y1))
(at-car-vertical yellow-car cube-x2-y4 cube-x2-y5)
(not (clear cube-x2-y4))
(not (clear cube-x2-y5))
(at-car-vertical green-hover-car cube-x3-y2 cube-x3-y3)
(not (clear cube-x3-y2))
(not (clear cube-x3-y3))
(at-car-vertical white-gray-car cube-x5-y2 cube-x5-y3)
(not (clear cube-x5-y2))
(not (clear cube-x5-y3))
(at-truck-horizontal blue-truck cube-x3-y4 cube-x4-y4 cube-x5-y4)
(not (clear cube-x3-y4))
(not (clear cube-x4-y4))
(not (clear cube-x5-y4))
(at-truck-horizontal purple-truck cube-x3-y5 cube-x4-y5 cube-x5-y5)
(not (clear cube-x3-y5))
(not (clear cube-x4-y5))
(not (clear cube-x5-y5))
(at-truck-vertical yellow-truck cube-x0-y2 cube-x0-y3 cube-x0-y4)
