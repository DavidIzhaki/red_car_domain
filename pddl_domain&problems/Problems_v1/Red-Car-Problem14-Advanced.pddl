(define (problem Red-Car-Problem14-Advanced)
(:domain RedCar)
(:objects
...
orange-car blue-sky-car purple-car green-car red-car green-hover-car pink-car white-gray-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
blue-truck green-truck yellow-truck purple-truck - truck
)
(:init
...
(at-car-horizontal green-hover-car cube-x4-y4 cube-x4-y5)
(not (clear cube-x4-y4))
(not (clear cube-x4-y5))
(at-car-horizontal pink-car cube-x0-y3 cube-x1-y3)
(not (clear cube-x0-y3))
(not (clear cube-x1-y3))
(at-car-horizontal white-gray-car cube-x1-y5 cube-x2-y5)
(not (clear cube-x1-y5))
(not (clear cube-x2-y5))
(at-car-vertical orange-car cube-x2-y2 cube-x2-y3)
(not (clear cube-x2-y2))
(not (clear cube-x2-y3))
(at-car-vertical blue-sky-car cube-x3-y2 cube-x3-y3)
(not (clear cube-x3-y2))
(not (clear cube-x3-y3))
(at-car-vertical purple-car cube-x3-y4 cube-x3-y5)
...
(at-truck-horizontal purple-truck cube-x1-y1 cube-x2-y1 cube-x3-y1)
(not (clear cube-x1-y1))
(not (clear cube-x2-y1))
(not (clear cube-x3-y1))
(at-truck-vertical blue-truck cube-x4-y1 cube-x4-y2 cube-x4-y3)
(not (clear cube-x4-y1))
(not (clear cube-x4-y2))
(not (clear cube-x4-y3))
(at-truck-vertical green-truck cube-x5-y1 cube-x5-y2 cube-x5-y3)
