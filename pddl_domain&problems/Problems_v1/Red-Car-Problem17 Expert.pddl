(define (problem Red-Car-Problem17 Expert)
(:domain RedCar)
(:objects
...
orange-car blue-sky-car pink-car purple-car yellow-car green-hover-car yellow-hover-car red-car green-car brown-car white-gray-car - car
...
(at-car-horizontal brown-car cube-x3-y5 cube-x4-y5)
(not (clear cube-x3-y5))
(not (clear cube-x4-y5))
(at-car-horizontal white-gray-car cube-x1-y3 cube-x2-y3)
...
(at-car-vertical pink-car cube-x0-y1 cube-x0-y2)
(not (clear cube-x0-y1))
(not (clear cube-x0-y2))
(at-car-vertical purple-car cube-x1-y1 cube-x1-y2)
...
(at-truck-vertical yellow-truck cube-x4-y2 cube-x4-y3 cube-x4-y4)
