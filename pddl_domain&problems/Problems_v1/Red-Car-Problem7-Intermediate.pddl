(define (problem Red-Car-Problem7-Intermediate)
(:domain RedCar)
(:objects
...
pink-car purple-car green-car green-over-car white-gray-car yellow-car brown-car yellow-special-car red-car brown-sky-car orange-car blue-sky-car - car
...
(at-car-horizontal brown-sky-car cube-x0-y3 cube-x1-y3)
(not (clear cube-x0-y3))
(not (clear cube-x1-y3))
(at-car-horizontal orange-car cube-x4-y0 cube-x5-y0)
...
(at-car-vertical pink-car cube-x2-y2 cube-x2-y3)
(not (clear cube-x2-y2))
(not (clear cube-x2-y3))
(at-car-vertical purple-car cube-x3-y2 cube-x3-y3)
(not (clear cube-x3-y2))
(not (clear cube-x3-y3))
(at-car-vertical green-car cube-x3-y0 cube-x3-y1)
(not (clear cube-x3-y0))
(not (clear cube-x3-y1))
(at-car-vertical green-over-car cube-x4-y2 cube-x4-y3)
...
(at-car-vertical yellow-car cube-x0-y4 cube-x0-y5)
(not (clear cube-x0-y4))
(not (clear cube-x0-y5))
(at-car-vertical brown-car cube-x4-y4 cube-x4-y5)
(not (clear cube-x4-y4))
(not (clear cube-x4-y5))
(at-car-vertical yellow-special-car cube-x5-y4 cube-x5-y5)
...
(at-truck-horizontal yellow-truck cube-x1-y4 cube-x2-y4 cube-x3-y4)
