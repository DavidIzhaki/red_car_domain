(define (problem Red-Car-Problem20 Expert)
(:domain RedCar)
(:objects
...
green-car pink-car yellow-car purple-car blue-sky-car red-car green-hover-car yellow-hover-car orange-car white-gray-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
purple-truck yellow-truck blue-truck - truck
)
(:init
...
(at-car-horizontal blue-sky-car cube-x2-y1 cube-x3-y1)
...
(at-car-horizontal green-hover-car cube-x0-y3 cube-x1-y3)
(not (clear cube-x0-y3))
(not (clear cube-x1-y3))
(at-car-horizontal yellow-hover-car cube-x1-y4 cube-x2-y4)
(not (clear cube-x1-y4))
(not (clear cube-x2-y4))
(at-car-horizontal orange-car cube-x1-y0 cube-x2-y0)
(not (clear cube-x1-y0))
(not (clear cube-x2-y0))
(at-car-horizontal white-gray-car cube-x3-y3 cube-x4-y3)
...
(at-car-vertical pink-car cube-x4-y1 cube-x4-y2)
(not (clear cube-x4-y1))
(not (clear cube-x4-y2))
(at-car-vertical yellow-car cube-x3-y4 cube-x3-y5)
...
(at-truck-horizontal blue-truck cube-x0-y5 cube-x1-y5 cube-x2-y5)
(not (clear cube-x0-y5))
(not (clear cube-x1-y5))
(not (clear cube-x2-y5))
(at-truck-vertical purple-truck cube-x5-y3 cube-x5-y4 cube-x5-y5)
