(define (problem Red-Car-Problem10-Advanced)
(:domain RedCar)
(:objects
...
green-car orange-car green-over-car pink-car purple-car yellow-car yellow-over-car red-car blue-sky-car brown-car yellow-special-car white-gray-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
purple-truck yellow-truck - truck
)
(:init
...
(at-car-horizontal yellow-special-car cube-x2-y5 cube-x3-y5)
(not (clear cube-x2-y5))
(not (clear cube-x3-y5))
(at-car-horizontal white-gray-car cube-x2-y4 cube-x3-y4)
...
(at-car-vertical orange-car cube-x2-y0 cube-x2-y1)
(not (clear cube-x2-y0))
(not (clear cube-x2-y1))
(at-car-vertical green-over-car cube-x1-y3 cube-x1-y4)
...
(at-car-vertical purple-car cube-x4-y2 cube-x4-y3)
...
(at-truck-horizontal yellow-truck cube-x3-y1 cube-x4-y1 cube-x5-y1)
(not (clear cube-x3-y1))
(not (clear cube-x4-y1))
(not (clear cube-x5-y1))
(at-truck-vertical purple-truck cube-x0-y2 cube-x0-y3 cube-x0-y4)
