(define (problem Red-Car-Problem19 Expert)
(:domain RedCar)
(:objects
...
orange-car pink-car white-gray-car purple-car green-car green-hover-car yellow-car blue-sky-car red-car brown-car yellow-hover-car yellow-special-car - car
...
(at-car-horizontal brown-car cube-x1-y5 cube-x2-y5)
(not (clear cube-x1-y5))
(not (clear cube-x2-y5))
(at-car-horizontal yellow-hover-car cube-x2-y4 cube-x3-y4)
(not (clear cube-x2-y4))
(not (clear cube-x3-y4))
(at-car-horizontal yellow-special-car cube-x3-y5 cube-x4-y5)
...
(at-car-vertical white-gray-car cube-x0-y4 cube-x0-y5)
...
(at-car-vertical green-car cube-x2-y0 cube-x2-y1)
(not (clear cube-x2-y0))
(not (clear cube-x2-y1))
(at-car-vertical green-hover-car cube-x1-y3 cube-x1-y4)
...
(at-truck-vertical purple-truck cube-x4-y2 cube-x4-y3 cube-x4-y4)
