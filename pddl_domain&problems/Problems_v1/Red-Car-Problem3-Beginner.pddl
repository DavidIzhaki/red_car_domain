(define (problem Red-Car-Problem3-Beginner)
(:domain RedCar)
(:objects
...
pink-car blue-car purple-car white-car yellow-car red-car green-car orange-car green-over-car - car
...
(at-car-horizontal green-car cube-x2-y0 cube-x3-y0)
...
(at-car-horizontal green-over-car cube-x4-y3 cube-x5-y3)
(not (clear cube-x4-y3))
(not (clear cube-x5-y3))
(at-car-vertical pink-car cube-x1-y3 cube-x1-y4)
(not (clear cube-x1-y3))
(not (clear cube-x1-y4))
(at-car-vertical blue-car cube-x5-y1 cube-x5-y2)
(not (clear cube-x5-y1))
(not (clear cube-x5-y2))
(at-car-vertical purple-car cube-x3-y3 cube-x3-y4)
(not (clear cube-x3-y3))
(not (clear cube-x3-y4))
(at-car-vertical white-car cube-x4-y4 cube-x4-y5)
...
(at-truck-vertical yellow-truck cube-x1-y0 cube-x1-y1 cube-x1-y2)
