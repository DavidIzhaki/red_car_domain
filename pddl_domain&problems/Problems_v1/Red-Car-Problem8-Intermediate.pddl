(define (problem Red-Car-Problem8-Intermediate)
(:domain RedCar)
(:objects
...
pink-car orange-car green-over-car yellow-special-car white-gray-car red-car blue-sky-car green-car purple-car yellow-car brown-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
purple-truck blue-truck yellow-truck - truck
)
(:init
...
(at-car-horizontal blue-sky-car cube-x0-y1 cube-x1-y1)
(not (clear cube-x0-y1))
(not (clear cube-x1-y1))
(at-car-horizontal green-car cube-x3-y0 cube-x4-y0)
(not (clear cube-x3-y0))
(not (clear cube-x4-y0))
(at-car-horizontal purple-car cube-x3-y1 cube-x4-y1)
(not (clear cube-x3-y1))
(not (clear cube-x4-y1))
(at-car-horizontal yellow-car cube-x1-y4 cube-x2-y4)
...
(at-car-vertical pink-car cube-x2-y1 cube-x2-y2)
...
(at-car-vertical green-over-car cube-x5-y2 cube-x5-y3)
(not (clear cube-x5-y2))
(not (clear cube-x5-y3))
(at-car-vertical yellow-special-car cube-x0-y4 cube-x0-y5)
(not (clear cube-x0-y4))
(not (clear cube-x0-y5))
(at-car-vertical white-gray-car cube-x4-y3 cube-x4-y4)
...
(at-truck-horizontal yellow-truck cube-x0-y0 cube-x1-y0 cube-x2-y0)
(not (clear cube-x0-y0))
(not (clear cube-x1-y0))
(not (clear cube-x2-y0))
(at-truck-vertical purple-truck cube-x3-y2 cube-x3-y3 cube-x3-y4)
