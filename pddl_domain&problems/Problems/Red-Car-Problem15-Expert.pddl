...
orange-car pink-car green-car purple-car yellow-car green-hover-car white-gray-car red-car yellow-hover-car brown-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
yellow-truck blue-truck purple-truck - truck
)
(:init
