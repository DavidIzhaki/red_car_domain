(define (problem Red-Car-Problem13-Advanced)
(:domain RedCar)
(:objects
...
orange-car pink-car red-car green-car purple-car blue-sky-car - car
...
(at-car-horizontal purple-car cube-x1-y4 cube-x2-y4)
(not (clear cube-x1-y4))
(not (clear cube-x2-y4))
(at-car-horizontal blue-sky-car cube-x4-y3 cube-x5-y3)
...
(at-car-vertical pink-car cube-x0-y4 cube-x0-y5)
(not (clear cube-x0-y4))
(not (clear cube-x0-y5))
(at-truck-vertical purple-truck cube-x5-y0 cube-x5-y1 cube-x5-y2)
(not (clear cube-x5-y0))
(not (clear cube-x5-y1))
(not (clear cube-x5-y2))
(at-truck-vertical yellow-truck cube-x2-y0 cube-x2-y1 cube-x2-y2)
(not (clear cube-x2-y0))
(not (clear cube-x2-y1))
(not (clear cube-x2-y2))
(at-truck-vertical blue-truck cube-x3-y3 cube-x3-y4 cube-x3-y5)
