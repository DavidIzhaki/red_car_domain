(define (problem Red-Car-Problem2-Beginner)
(:domain RedCar)
(:objects
...
green-car orange-car pink-car green-over-car white-car gray-car red-car blue-car purple-car - car
...
(at-car-horizontal blue-car cube-x2-y0 cube-x3-y0)
(not (clear cube-x2-y0))
(not (clear cube-x3-y0))
(at-car-horizontal purple-car cube-x2-y1 cube-x3-y1)
(not (clear cube-x2-y1))
(not (clear cube-x3-y1))
(at-car-vertical green-car cube-x0-y1 cube-x0-y2)
(not (clear cube-x0-y1))
(not (clear cube-x0-y2))
(at-car-vertical orange-car cube-x1-y1 cube-x1-y2)
(not (clear cube-x1-y1))
(not (clear cube-x1-y2))
(at-car-vertical pink-car cube-x4-y1 cube-x4-y2)
(not (clear cube-x4-y1))
(not (clear cube-x4-y2))
(at-car-vertical green-over-car cube-x2-y2 cube-x2-y3)
(not (clear cube-x2-y2))
(not (clear cube-x2-y3))
(at-car-vertical white-car cube-x2-y4 cube-x2-y5)
(not (clear cube-x2-y4))
(not (clear cube-x2-y5))
(at-car-vertical gray-car cube-x4-y3 cube-x4-y4)
(not (clear cube-x4-y3))
(not (clear cube-x4-y4))
(at-truck-vertical yellow-truck cube-x3-y2 cube-x3-y3 cube-x3-y4)
