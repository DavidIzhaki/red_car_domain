(define (problem Red-Car-Problem12-Advanced)
(:domain RedCar)
(:objects
...
orange-car pink-car purple-car red-car green-car green-over-car blue-sky-car - car
...
(at-car-horizontal green-over-car cube-x4-y5 cube-x5-y5)
...
(at-car-vertical pink-car cube-x5-y3 cube-x5-y4)
...
(at-truck-horizontal blue-truck cube-x1-y3 cube-x2-y3 cube-x3-y3)
