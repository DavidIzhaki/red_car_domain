(define (problem Red-Car-Problem5-Intermediate)
(:domain RedCar)
(:objects
...
pink-car blue-car orange-car green-over-car red-car purple-car green-car - car
...
(at-car-horizontal purple-car cube-x0-y4 cube-x1-y4)
...
(at-car-vertical pink-car cube-x4-y2 cube-x4-y3)
(not (clear cube-x4-y2))
(not (clear cube-x4-y3))
(at-car-vertical blue-car cube-x0-y1 cube-x0-y2)
...
(at-car-vertical green-over-car cube-x5-y4 cube-x5-y5)
(not (clear cube-x5-y4))
(not (clear cube-x5-y5))
(at-truck-horizontal purple-truck cube-x2-y4 cube-x3-y4 cube-x4-y4)
