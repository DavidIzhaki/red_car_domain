(define (problem Red-Car-Problem6-Intermediate)
(:domain RedCar)
(:objects
...
pink-car green-car yellow-car yellow-over-car purple-car green-over-car red-car orange-car blue-sky-car gray-white-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
yellow-truck purple-truck blue-truck green-truck - truck
)
(:init
...
(at-car-horizontal red-car cube-x3-y2 cube-x4-y2)
...
(at-car-horizontal blue-sky-car cube-x4-y0 cube-x5-y0)
...
(at-car-vertical pink-car cube-x1-y2 cube-x1-y3)
...
(at-car-vertical yellow-car cube-x5-y4 cube-x5-y5)
(not (clear cube-x5-y4))
(not (clear cube-x5-y5))
(at-car-vertical yellow-over-car cube-x4-y4 cube-x4-y5)
(not (clear cube-x4-y4))
(not (clear cube-x4-y5))
(at-car-vertical purple-car cube-x5-y2 cube-x5-y3)
...
(at-truck-horizontal purple-truck cube-x3-y2 cube-x4-y2 cube-x5-y2)
(not (clear cube-x3-y2))
(not (clear cube-x4-y2))
(not (clear cube-x5-y2))
(at-truck-horizontal blue-truck cube-x1-y4 cube-x2-y4 cube-x3-y4)
(not (clear cube-x1-y4))
(not (clear cube-x2-y4))
(not (clear cube-x3-y4))
(at-truck-horizontal green-truck cube-x0-y5 cube-x1-y5 cube-x2-y5)
(not (clear cube-x0-y5))
(not (clear cube-x1-y5))
(not (clear cube-x2-y5))
(at-truck-vertical yellow-truck cube-x0-y1 cube-x0-y2 cube-x0-y3)
