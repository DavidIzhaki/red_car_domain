(define (problem Red-Car-Problem9-Advanced)
(:domain RedCar)
(:objects
...
green-car purple-car green-over-car pink-car blue-sky-car white-gray-car yellow-special-car yellow-over-car red-car orange-car brown-car - car
;;Trucks:  Represents trucks in the grid, identified by their names (e.g., green-truck).
yellow-truck purple-truck blue-truck - truck
)
(:init
...
(at-car-horizontal orange-car cube-x2-y0 cube-x3-y0)
(not (clear cube-x2-y0))
(not (clear cube-x3-y0))
(at-car-horizontal brown-car cube-x4-y5 cube-x5-y5)
(not (clear cube-x4-y5))
(not (clear cube-x5-y5))
(at-car-vertical green-car cube-x1-y0 cube-x1-y1)
(not (clear cube-x1-y0))
(not (clear cube-x1-y1))
(at-car-vertical purple-car cube-x2-y1 cube-x2-y2)
(not (clear cube-x2-y1))
(not (clear cube-x2-y2))
(at-car-vertical green-over-car cube-x3-y1 cube-x3-y2)
(not (clear cube-x3-y1))
(not (clear cube-x3-y2))
(at-car-vertical pink-car cube-x5-y0 cube-x5-y1)
(not (clear cube-x5-y0))
(not (clear cube-x5-y1))
(at-car-vertical blue-sky-car cube-x4-y0 cube-x4-y1)
(not (clear cube-x4-y0))
(not (clear cube-x4-y1))
(at-car-vertical white-gray-car cube-x4-y2 cube-x4-y3)
(not (clear cube-x4-y2))
(not (clear cube-x4-y3))
(at-car-vertical yellow-special-car cube-x2-y3 cube-x2-y4)
(not (clear cube-x2-y3))
(not (clear cube-x2-y4))
(at-car-vertical yellow-over-car cube-x3-y3 cube-x3-y4)
(not (clear cube-x3-y3))
(not (clear cube-x3-y4))
(at-truck-horizontal blue-truck cube-x1-y5 cube-x2-y5 cube-x3-y5)
(not (clear cube-x1-y5))
(not (clear cube-x2-y5))
(not (clear cube-x3-y5))
(at-truck-vertical yellow-truck cube-x5-y2 cube-x5-y3 cube-x5-y4)
(not (clear cube-x5-y2))
(not (clear cube-x5-y3))
(not (clear cube-x5-y4))
(at-truck-vertical purple-truck cube-x0-y3 cube-x0-y4 cube-x0-y5)
